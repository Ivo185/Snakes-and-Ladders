...
class FullscreenGameApp:
    ...
    def show_scene_game(self):
        ...
        self.zar_item = self.canvas.create_image(left_margin_center, int(200 * self.scale), image=initial_dice_img, tags="dice")
        ...
        self.canvas.create_text(right_margin_center, int(90 * self.scale), text="⚙ Настройки COM", fill="black", font=("Arial", settings_font, "bold"), tags="settings_btn")
        ...
        self.canvas.tag_bind("settings_btn", "<Leave>", lambda e: (self.canvas.itemconfig("settings_btn", fill="black"), self.canvas.config(cursor="")))
        
        self.canvas.create_text(right_margin_center, int(130 * self.scale), text="↻ Обнови връзката", fill="black", font=("Arial", settings_font, "bold"), tags="refresh_mb_btn")
        ...
        self.canvas.tag_bind("refresh_mb_btn", "<Leave>", lambda e: (self.canvas.itemconfig("refresh_mb_btn", fill="black"), self.canvas.config(cursor="")))
        
        self.canvas.create_text(right_margin_center, int(170 * self.scale), text="✖ Разкачи micro:bit", fill="black", font=("Arial", settings_font, "bold"), tags="disconnect_mb_btn")
        ...
        self.canvas.tag_bind("disconnect_mb_btn", "<Leave>", lambda e: (self.canvas.itemconfig("disconnect_mb_btn", fill="black"), self.canvas.config(cursor="")))
